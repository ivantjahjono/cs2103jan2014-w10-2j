...
public class Error {
	...
	private static final String MESSAGE_DUPLICTE_COMMAND_PARAMETERS = "INVALID COMMAND SYNTAX!";
	...
	enum ERROR_TYPE {
		INVALID_INPUT_COMMAND, MESSAGE_DUPLICTE_COMMAND_PARAMETERS, INVALID_INPUT_DATE_FORMAT, INVALID_INPUT_TASKNAME 
	}
	...
	public String getErrorMessage () {
		...
		case MESSAGE_DUPLICTE_COMMAND_PARAMETERS:
			return MESSAGE_DUPLICTE_COMMAND_PARAMETERS;
